...
int main(int argc, char** argv) {
    ...
    for (const auto& imu : valid_imu) {
        ...
        auto* factor = ContinuousInertialFactor::Create(
            ...
            spline_dt, control_points[k].timestamp()
        );
