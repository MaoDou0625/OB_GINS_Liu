...
WheelPreintegrationEarthOdo::WheelPreintegrationEarthOdo(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0,
...
Eigen::MatrixXd WheelPreintegrationEarthOdo::evaluate(const IntegrationState &state0, const IntegrationState &state1,
                                                 double *residuals) {
    sqrt_information_ =
...
Eigen::MatrixXd WheelPreintegrationEarthOdo::residualJacobianPose0(const IntegrationState &state0,
...
Eigen::MatrixXd WheelPreintegrationEarthOdo::residualJacobianPose1(const IntegrationState &state0,
                                                              const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_POSE, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
Eigen::MatrixXd WheelPreintegrationEarthOdo::residualJacobianMix0(const IntegrationState &state0,
                                                             const IntegrationState &state1, double *jacobian) {
...
Eigen::MatrixXd WheelPreintegrationEarthOdo::residualJacobianMix1(const IntegrationState &state0,
                                                             const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_MIX, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
int WheelPreintegrationEarthOdo::numResiduals() {
    return NUM_STATE;
}

vector<int> WheelPreintegrationEarthOdo::numBlocksParameters() {
    return std::vector<int>{NUM_POSE, NUM_MIX, NUM_POSE, NUM_MIX};
}

IntegrationStateData WheelPreintegrationEarthOdo::stateToData(const IntegrationState &state) {
...
IntegrationState WheelPreintegrationEarthOdo::stateFromData(const IntegrationStateData &data) {
    IntegrationState state;
...
void WheelPreintegrationEarthOdo::constructState(const double *const *parameters, IntegrationState &state0,
...
void WheelPreintegrationEarthOdo::resetState(const IntegrationState &state) {
...
void WheelPreintegrationEarthOdo::resetState(const IntegrationState &state, int num) {
    delta_time_ = 0;
...
int WheelPreintegrationEarthOdo::imuErrorNumResiduals() {
    return NUM_ERROR_RESIDUAL;
}

vector<int> WheelPreintegrationEarthOdo::imuErrorNumBlocksParameters() {
