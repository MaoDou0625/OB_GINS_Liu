/*
 * Wheel-IMU Preintegration Base (implementation)
 */

#include "preintegration_wheel_base.h"

WheelPreintegrationBase::WheelPreintegrationBase(std::shared_ptr<WheelIntegrationParameters> parameters,
...
void WheelPreintegrationBase::reintegration(WheelIntegrationState &state) {
    current_state_ = std::move(state);
...
void WheelPreintegrationBase::stateToData(const WheelIntegrationState &state, WheelIntegrationStateData &data) {
...
void WheelPreintegrationBase::stateFromData(const WheelIntegrationStateData &data, WheelIntegrationState &state) {
