...
#ifndef WHEEL_IMU_PREINTEGRATION_BASE_H
#define WHEEL_IMU_PREINTEGRATION_BASE_H
...
public:
    WheelPreintegrationBase(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0, IntegrationState state);
...
private:
    static IMU convertRbdToFrd(const IMU &imu);
...
#endif // WHEEL_IMU_PREINTEGRATION_BASE_H
