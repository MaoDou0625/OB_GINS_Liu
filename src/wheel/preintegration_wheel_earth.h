/* Wheel-IMU Preintegration with Earth rotation */

#ifndef WHEEL_PREINTEGRATION_EARTH_H
...
public:
    WheelPreintegrationEarth(std::shared_ptr<WheelIntegrationParameters> parameters, const IMU &imu0,
...
#endif // WHEEL_PREINTEGRATION_EARTH_H
