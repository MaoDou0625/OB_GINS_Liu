...
WheelPreintegrationEarth::WheelPreintegrationEarth(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0,
...
Eigen::MatrixXd WheelPreintegrationEarth::evaluate(const IntegrationState &state0, const IntegrationState &state1,
                                              double *residuals) {
    sqrt_information_ =
...
Eigen::MatrixXd WheelPreintegrationEarth::residualJacobianPose0(const IntegrationState &state0,
...
Eigen::MatrixXd WheelPreintegrationEarth::residualJacobianPose1(const IntegrationState &state0,
                                                           const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_POSE, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
Eigen::MatrixXd WheelPreintegrationEarth::residualJacobianMix0(const IntegrationState &state0,
                                                          const IntegrationState &state1, double *jacobian) {
...
Eigen::MatrixXd WheelPreintegrationEarth::residualJacobianMix1(const IntegrationState &state0,
                                                          const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_MIX, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
vector<int> WheelPreintegrationEarth::numBlocksParameters() {
    return std::vector<int>{NUM_POSE, NUM_MIX, NUM_POSE, NUM_MIX};
}

IntegrationStateData WheelPreintegrationEarth::stateToData(const IntegrationState &state) {
    IntegrationStateData data;
    WheelPreintegrationBase::stateToData(state, data);
    return data;
}

IntegrationState WheelPreintegrationEarth::stateFromData(const IntegrationStateData &data) {
    IntegrationState state;
    WheelPreintegrationBase::stateFromData(data, state);
    return state;
}

void WheelPreintegrationEarth::constructState(const double *const *parameters, IntegrationState &state0,
...
void WheelPreintegrationEarth::resetState(const IntegrationState &state) {
...
void WheelPreintegrationEarth::resetState(const IntegrationState &state, int num) {
    delta_time_ = 0;
...
int WheelPreintegrationEarth::imuErrorNumResiduals() {
    return 6;
}

vector<int> WheelPreintegrationEarth::imuErrorNumBlocksParameters() {
