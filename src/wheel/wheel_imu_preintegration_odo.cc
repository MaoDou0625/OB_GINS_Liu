...
WheelPreintegrationOdo::WheelPreintegrationOdo(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0,
...
Eigen::MatrixXd WheelPreintegrationOdo::evaluate(const IntegrationState &state0, const IntegrationState &state1,
                                            double *residuals) {
    sqrt_information_ =
...
Eigen::MatrixXd WheelPreintegrationOdo::residualJacobianPose0(const IntegrationState &state0, const IntegrationState &state1,
                                                         double *jacobian) {
...
Eigen::MatrixXd WheelPreintegrationOdo::residualJacobianPose1(const IntegrationState &state0, const IntegrationState &state1,
                                                         double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_POSE, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
Eigen::MatrixXd WheelPreintegrationOdo::residualJacobianMix0(const IntegrationState &state0, const IntegrationState &state1,
                                                        double *jacobian) {
...
Eigen::MatrixXd WheelPreintegrationOdo::residualJacobianMix1(const IntegrationState &state0, const IntegrationState &state1,
                                                        double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_MIX, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
int WheelPreintegrationOdo::numResiduals() {
    return NUM_STATE;
}

vector<int> WheelPreintegrationOdo::numBlocksParameters() {
    return vector<int>{NUM_POSE, NUM_MIX, NUM_POSE, NUM_MIX};
}

IntegrationStateData WheelPreintegrationOdo::stateToData(const IntegrationState &state) {
...
IntegrationState WheelPreintegrationOdo::stateFromData(const IntegrationStateData &data) {
    IntegrationState state;
...
void WheelPreintegrationOdo::constructState(const double *const *parameters, IntegrationState &state0,
...
void WheelPreintegrationOdo::resetState(const IntegrationState &state) {
...
void WheelPreintegrationOdo::resetState(const IntegrationState &state, int num) {
...
int WheelPreintegrationOdo::imuErrorNumResiduals() {
    return NUM_ERROR_RESIDUAL;
}

vector<int> WheelPreintegrationOdo::imuErrorNumBlocksParameters() {
