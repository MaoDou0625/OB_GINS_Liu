/* Wheel-IMU Preintegration with odometer */

#ifndef WHEEL_PREINTEGRATION_ODO_H
#define WHEEL_PREINTEGRATION_ODO_H

#include "preintegration_wheel_base.h"

class WheelPreintegrationOdo : public WheelPreintegrationBase {
public:
    WheelPreintegrationOdo(std::shared_ptr<WheelIntegrationParameters> parameters, const IMU &imu0,
...
#endif // WHEEL_PREINTEGRATION_ODO_H
