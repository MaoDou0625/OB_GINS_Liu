...
#ifndef FACTOR_WHEEL_IMU_H
#define FACTOR_WHEEL_IMU_H

#include "wheel_imu_preintegration_base.h"

#include <ceres/ceres.h>

class WheelImuFactor : public ceres::CostFunction {

public:
    WheelImuFactor() = delete;

    explicit WheelImuFactor(std::shared_ptr<WheelPreintegrationBase> preintegration)
