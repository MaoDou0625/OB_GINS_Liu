...
#ifndef WHEEL_IMU_PREINTEGRATION_NORMAL_H
#define WHEEL_IMU_PREINTEGRATION_NORMAL_H
...
public:
    WheelPreintegrationNormal(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0, IntegrationState state);
...
#endif // WHEEL_IMU_PREINTEGRATION_NORMAL_H
