...
#ifndef WHEEL_IMU_PREINTEGRATION_ODO_H
#define WHEEL_IMU_PREINTEGRATION_ODO_H
...
public:
    WheelPreintegrationOdo(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0, IntegrationState state);
...
#endif // WHEEL_IMU_PREINTEGRATION_ODO_H
