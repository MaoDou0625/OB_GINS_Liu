...
#ifndef WHEEL_IMU_PREINTEGRATION_EARTH_ODO_H
#define WHEEL_IMU_PREINTEGRATION_EARTH_ODO_H
...
public:
    WheelPreintegrationEarthOdo(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0, IntegrationState state);
...
#endif // WHEEL_IMU_PREINTEGRATION_EARTH_ODO_H
