...
WheelPreintegrationNormal::WheelPreintegrationNormal(std::shared_ptr<IntegrationParameters> parameters, const IMU &imu0,
...
Eigen::MatrixXd WheelPreintegrationNormal::evaluate(const IntegrationState &state0, const IntegrationState &state1,
                                               double *residuals) {
    sqrt_information_ =
...
Eigen::MatrixXd WheelPreintegrationNormal::residualJacobianPose0(const IntegrationState &state0,
...
Eigen::MatrixXd WheelPreintegrationNormal::residualJacobianPose1(const IntegrationState &state0,
                                                            const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_POSE, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
Eigen::MatrixXd WheelPreintegrationNormal::residualJacobianMix0(const IntegrationState &state0,
                                                           const IntegrationState &state1, double *jacobian) {
...
Eigen::MatrixXd WheelPreintegrationNormal::residualJacobianMix1(const IntegrationState &state0,
                                                           const IntegrationState &state1, double *jacobian) {
    Eigen::Map<Eigen::Matrix<double, NUM_STATE, NUM_MIX, Eigen::RowMajor>> jaco(jacobian);
    jaco.setZero();
...
vector<int> WheelPreintegrationNormal::numBlocksParameters() {
    return std::vector<int>{NUM_POSE, NUM_MIX, NUM_POSE, NUM_MIX};
}

IntegrationStateData WheelPreintegrationNormal::stateToData(const IntegrationState &state) {
    IntegrationStateData data;
    WheelPreintegrationBase::stateToData(state, data);
    return data;
}

IntegrationState WheelPreintegrationNormal::stateFromData(const IntegrationStateData &data) {
    IntegrationState state;
    WheelPreintegrationBase::stateFromData(data, state);
    return state;
}

void WheelPreintegrationNormal::constructState(const double *const *parameters, IntegrationState &state0,
...
void WheelPreintegrationNormal::resetState(const IntegrationState &state) {
...
void WheelPreintegrationNormal::resetState(const IntegrationState &state, int num) {
    delta_time_ = 0;
...
vector<int> WheelPreintegrationNormal::imuErrorNumBlocksParameters() {
